...
import DynamicList from "../DynamicList/index.tsx"
...
export default class ReactVirtual extends Component {
   render(){
      return <div style={{height:"300px",width:"300px",overflow:"srcoll"}}>
               {
                 list.map((item,index)=>{
